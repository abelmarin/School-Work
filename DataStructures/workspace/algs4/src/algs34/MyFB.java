...
public class MyFB {
	...
	static class Person {
		...
		public int hashCode () {
			int result = 17;
			result = name.hashCode() + 19 * result;
			result = Integer.hashCode(age) + 19 * result;
			return result;
		}
	}
	...
	public void addPerson (Person p) {
		if (! map.containsKey(p)) map.put(p, new HashSet<Person>());
	...
	public void removeFriendship (Person p1, Person p2) {
		if (! map.containsKey(p1) || ! map.containsKey(p2)) return;
