...
public class MyRunnable implements Runnable {
    ...
    public void run() {
        ...
        mainActivity.runOnUiThread(() -> mainActivity.whenRunnableIsDone(MainActivity.formatter.format(new Date())));
    ...
    private void displayProgress(final int value) {
        // Don't try to update the UI from this thread - do
        // that on the UI thread
        mainActivity.runOnUiThread(() -> mainActivity.updateProgressBar(value));
