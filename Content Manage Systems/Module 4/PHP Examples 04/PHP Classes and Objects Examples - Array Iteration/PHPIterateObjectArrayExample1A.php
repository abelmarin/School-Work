<?php
//File Name: PHPIterateObjectArrayExample1A.php
//Purpose: Example of how to dump and iterate an Array of Objects with get methods
//Author: Mike H Chase
//Date: 12-12-2019
...
foreach($personArray as $key=>$obj)
{
   ...
   echo "Age:". $obj->get_age() ."<br>";
   echo "Weight:". $obj->get_weight() ."<br>" . "<p>";
}
