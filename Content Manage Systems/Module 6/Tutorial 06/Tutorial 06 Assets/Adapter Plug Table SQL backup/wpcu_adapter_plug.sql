...
--
-- Table structure for table `wpcu_adapter_plug`
--

CREATE TABLE `wpcu_adapter_plug` (
  `ID` int(11) NOT NULL,
...
--
-- Dumping data for table `wpcu_adapter_plug`
--

INSERT INTO `wpcu_adapter_plug` (`ID`, `name`, `description`, `size`, `color`, `cost`) VALUES
...
--
-- Indexes for table `wpcu_adapter_plug`
--
ALTER TABLE `wpcu_adapter_plug`
  ADD PRIMARY KEY (`ID`);
...
--
-- AUTO_INCREMENT for table `wpcu_adapter_plug`
--
ALTER TABLE `wpcu_adapter_plug`
