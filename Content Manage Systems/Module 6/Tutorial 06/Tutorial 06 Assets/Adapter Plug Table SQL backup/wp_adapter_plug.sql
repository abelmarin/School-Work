...
--
-- Table structure for table `wp_adapter_plug`
--

CREATE TABLE `wp_adapter_plug` (
  `ID` int(11) NOT NULL,
...
--
-- Dumping data for table `wp_adapter_plug`
--

INSERT INTO `wp_adapter_plug` (`ID`, `name`, `description`, `size`, `color`, `cost`) VALUES
...
--
-- Indexes for table `wp_adapter_plug`
--
ALTER TABLE `wp_adapter_plug`
  ADD PRIMARY KEY (`ID`);
...
--
-- AUTO_INCREMENT for table `wp_adapter_plug`
--
ALTER TABLE `wp_adapter_plug`
